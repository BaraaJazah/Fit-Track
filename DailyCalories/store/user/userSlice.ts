        ...
        addFood: (state, actions) => {
            ...
            if (actions.payload.meal !== "exercise") {
                ...
                const data = {
                    ...
                    food_name: actions.payload.mealData.name,
                    quan: 100,
                ...
                const data = {
                    id: actions.payload.mealData.id,
                    name: actions.payload.mealData.name,
                    quan: 60,
...
export const { addFood, addWater, resetFood, deleteFood, updateFoodQuan } = userSlice.actions;
export { };
