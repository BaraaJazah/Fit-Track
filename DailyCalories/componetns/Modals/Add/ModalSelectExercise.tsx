...
import { ExerciseSelcetCart } from '../../screens/Exercise'
...
const ModalSelectExercise = ({ name, isOpen = false, isOpenFunc }) => {
    ...
    return (
        ...
        >
            ...
            <KeyboardAvoidingView style={{ position: "absolute", flex: 1 }} >
                        ...
                        <View style={{}}>
                            <View style={[styles.searchView, { borderColor: themeData['background-secondary'] }]}>
                                ...
                                <View style={{ backgroundColor: themeData['background-primary'], width: 28, height: 28, borderRadius: 50, alignItems: "center", justifyContent: "center" }}>
                                    <Text style={{ color: themeData['background-secondary'] }}>{exerciseData1?.length}</Text>
                                </View>
                            </View>
                                                    ...
                                                    <View key={index} style={{ width: width, height: "100%", alignItems: "center", marginTop: 10 }}>
                                                        {
                                                            item.exercises.map((item, index) => {
                                                                return <ExerciseSelcetCart key={index} data={item} weight={weight} />
