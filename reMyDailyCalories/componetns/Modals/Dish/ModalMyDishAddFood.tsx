...
const ModalMyDishAddFood = ({ name, isOpen = false, isOpenFunc }) => {
    ...
    >
      ...
      >
        ...
        {showViewPager ? (
          ...
          <MotiSafeAreaView style={styles.container2}>
            <LottieFile
              lottieName="loading"
              lottieHeigh={150}
              lottieWidth={150}
...
export default ModalMyDishAddFood;
