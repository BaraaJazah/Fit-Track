...
import { close, email, eye, eyeOff, lock } from "../../assets/icons";
    ...
    <View style={styles.body}>
      ...
      <View style={styles.main}>
        <Packet>
          ...
          >
            Enter your register email address. and we’ll send you a one-time
            verification code to reset your password
          </Text>
        </Packet>

        <Packet packetStyle={{ alignItems: "center", paddingTop: 0 }}>
          <Input title={"Password"} leftIcon={lock} rightIcon={eye} />
          <Input title={"Confirm Password"} leftIcon={lock} rightIcon={eye} />
